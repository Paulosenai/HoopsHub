...
export default function Home({ navigation }) {
  ...
  const newsData = [
    ...
    { title: 'ARREMESSO', image: require('../../../res/img/arremesso.gif'), screen: 'EstatisticasArremesso' },
    { title: 'PASSES', image: require('../../../res/img/passe.gif'), screen: 'EstatisticasPasses' },
    { title: 'LAYUPS', image: require('../../../res/img/Layup.gif'), screen: 'EstatisticasLayups' },
  ];
  ...
  return (
    <SafeAreaView style={styles.scrollview}>
      ...
      <ScrollView>
        {newsData.map((item) => (
          <TouchableOpacity key={item.title} onPress={() => navigation.navigate(item.screen, item.title)}>
            <FastImage
              source={item.image}
